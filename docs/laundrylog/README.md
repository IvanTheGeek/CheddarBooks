...
If you want the first code-facing state shapes that sit between the current app and future shared primitives, go to [`fnhci-primitive-state-shapes.md`](fnhci-primitive-state-shapes.md).
