...
module ScreenHtmlRenderer =
    ...
    let private renderStyles (builder: StringBuilder) =
        ...
        appendLine builder "*, *::before, *::after { box-sizing: border-box; }"
        ...
        appendLine builder ".ll-panel--compact { padding: 0.8rem; }"
        ...
        appendLine builder ".ll-location-input { flex: 1; min-width: 0; display: flex; flex-direction: column; }"
        ...
        appendLine builder ".ll-gps-button { flex: 0 0 56px; width: 56px; min-height: 52px; border: 2px solid #e2e8f0; background: white; border-radius: 0.75rem; font-size: 1.5rem; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; justify-content: center; }"
        appendLine builder ".ll-gps-button:active { transform: scale(0.97); background: #fff8e1; border-color: #ffcc80; }"
        appendLine builder ".ll-primary-action-row { display: flex; flex-direction: column; gap: 0.5rem; margin-top: 0.15rem; }"
        appendLine builder ".ll-button { width: 100%; border: none; border-radius: 0.75rem; min-height: 60px; padding: 0.85rem 1rem; font-size: 1.02rem; font-weight: 700; cursor: pointer; transition: all 0.3s; display: flex; align-items: center; justify-content: center; flex-wrap: wrap; gap: 0.45rem; }"
        ...
        appendLine builder ".ll-option-group--payment .ll-chip--tile { min-height: 54px; padding: 0.65rem 0.4rem; }"
