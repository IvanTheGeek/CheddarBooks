...
module ScreenPathHtmlRenderer =
    ...
    let private renderPathStyles (builder: StringBuilder) =
        ...
        appendLine builder ".ll-path-document { padding: 14px 16px 28px; max-width: 100%; margin: 0 auto; }"
        appendLine builder ".ll-path-document__header { margin-bottom: 14px; display: flex; flex-direction: column; gap: 3px; }"
