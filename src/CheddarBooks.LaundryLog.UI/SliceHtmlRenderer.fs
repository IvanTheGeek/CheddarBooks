...
module SliceHtmlRenderer =
    ...
    let private renderStyles (builder: StringBuilder) =
        ...
        appendLine builder ".slice-card__app-pill { display: inline-flex; align-items: center; justify-content: center; padding: 3px 9px; border-radius: 999px; background: #ffb54d; color: white; font-size: 0.6rem; font-weight: 700; line-height: 1; }"
        appendLine builder ".slice-card__kind { color: #0e5883; font-size: 0.56rem; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; text-align: right; }"
        appendLine builder ".slice-card__title { margin: 7px 0 0; font-size: 0.82rem; line-height: 1.04; }"
        appendLine builder ".slice-card__description { margin: 3px 0 0; font-size: 0.62rem; line-height: 1.18; color: #506b87; min-height: 1.36em; }"
        ...
        appendLine builder ".slice-block__title { margin: 0; font-size: 0.58rem; line-height: 1.14; font-weight: 700; overflow-wrap: normal; word-break: normal; hyphens: none; grid-row: 2; }"
        appendLine builder ".slice-block--screen .slice-block__title { font-weight: 400; font-size: 0.56rem; white-space: nowrap; }"
        ...
        appendLine builder ".slice-block__property-line { font-family: \"IBM Plex Mono\", \"Cascadia Mono\", \"Consolas\", monospace; font-size: 0.54rem; line-height: 1.18; color: #27435c; overflow-wrap: break-word; word-break: normal; }"
