...
module SliceHtmlRenderer =
    ...
    let private renderSliceCardShell
        ...
        appendLine builder "<div class=\"slice-card__topline-right\">"
        appendLine builder "<button type=\"button\" class=\"slice-card__width-action\" data-action=\"toggle-slice-width\" aria-pressed=\"false\">Expand Width</button>"
    ...
    let private renderScript (builder: StringBuilder) =
        ...
        appendLine builder "      button.textContent = expanded ? 'Collapse Width' : 'Expand Width';"
    ...
    let private renderStyles (builder: StringBuilder) =
        ...
        appendLine builder ".slice-card__topline-right { display: inline-flex; align-items: center; gap: 8px; }"
        ...
        appendLine builder ".slice-card__width-action { border: 1px solid #9ab3d0; background: rgba(255, 255, 255, 0.92); color: #27435c; border-radius: 999px; padding: 2px 8px; font-size: 0.52rem; font-weight: 700; letter-spacing: 0.04em; cursor: pointer; white-space: nowrap; }"
