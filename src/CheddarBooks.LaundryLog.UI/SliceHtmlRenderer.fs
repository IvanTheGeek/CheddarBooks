...
module SliceHtmlRenderer =
    ...
    let private renderStyles (builder: StringBuilder) =
        ...
        appendLine builder ".path-document { --screen-row-min-height: 98px; --detail-row-min-height: 58px; --screen-snapshot-height: 22px; --slice-title-min-height: 2.15em; --slice-description-min-height: 2.36em; --property-value-indent: 1.2rem; padding: 8px 10px 10px; }"
        ...
        appendLine builder ".slice-card__title { margin: 7px 0 0; font-size: 0.82rem; line-height: 1.04; min-height: var(--slice-title-min-height); }"
        appendLine builder ".slice-card__description { margin: 3px 0 0; font-size: 0.66rem; line-height: 1.18; color: #506b87; min-height: var(--slice-description-min-height); }"
