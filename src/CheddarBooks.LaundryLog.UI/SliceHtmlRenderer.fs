...
module SliceHtmlRenderer =
    ...
    let private renderStyles (builder: StringBuilder) =
        ...
        appendLine builder ".slice-card { flex: 0 0 360px; min-height: 560px; border-radius: 22px; border: 4px solid #15263d; box-shadow: 0 12px 32px rgba(10, 27, 49, 0.12); padding: 14px 14px 16px; display: flex; flex-direction: column; }"
        ...
        appendLine builder ".slice-card__app-pill { display: inline-flex; align-items: center; justify-content: center; padding: 6px 14px; border-radius: 999px; background: #ffb54d; color: white; font-size: 0.82rem; font-weight: 700; line-height: 1; }"
        ...
        appendLine builder ".slice-card__title { margin: 14px 0 0; font-size: 1.95rem; line-height: 1.05; }"
        appendLine builder ".slice-card__description { margin: 8px 0 0; font-size: 1rem; color: #506b87; min-height: 2.6em; }"
        appendLine builder ".slice-card__body { display: flex; flex-direction: column; gap: 18px; margin-top: 26px; flex: 1; }"
        appendLine builder ".slice-block { display: flex; flex-direction: column; gap: 10px; border-radius: 16px; padding: 14px; border: 2px solid; min-height: 132px; }"
        ...
        appendLine builder ".slice-block__title { margin: 0; font-size: 1.16rem; line-height: 1.2; }"
        appendLine builder ".slice-block__badges { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 8px; }"
        appendLine builder ".slice-block__badge { display: inline-flex; align-items: center; justify-content: center; padding: 4px 10px; border-radius: 999px; border: 1px solid #c2d4e8; background: rgba(255, 255, 255, 0.92); font-size: 0.68rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; color: #4a647f; }"
        appendLine builder ".slice-block__badge--kind { color: #203954; }"
        appendLine builder ".slice-block__snapshot { min-height: 116px; border-radius: 12px; border: 1px dashed #c7d7ea; background: linear-gradient(180deg, #eef4fb 0%, #e7eef7 100%); display: flex; align-items: center; justify-content: center; text-align: center; padding: 14px; color: #7087a0; font-size: 0.98rem; font-weight: 600; }"
        appendLine builder ".slice-block__properties { display: flex; flex-direction: column; gap: 6px; background: rgba(255, 255, 255, 0.32); border-radius: 12px; padding: 12px 12px 10px; min-height: 84px; }"
        appendLine builder ".slice-block__properties--hidden { min-height: 0; padding: 0; background: transparent; }"
        appendLine builder ".slice-block__property-line { font-family: \"IBM Plex Mono\", \"Cascadia Mono\", \"Consolas\", monospace; font-size: 0.92rem; line-height: 1.35; color: #27435c; }"
        appendLine builder ".slice-block__footer { display: flex; justify-content: flex-end; margin-top: auto; }"
        appendLine builder ".slice-block__footer-badge { display: inline-flex; align-items: center; justify-content: center; padding: 4px 10px; border-radius: 999px; border: 1px solid #c6d4e2; background: rgba(255, 255, 255, 0.94); color: #566d86; font-size: 0.68rem; font-weight: 700; letter-spacing: 0.08em; text-transform: lowercase; }"
        appendLine builder "@media (max-width: 1200px) { .slice-card { flex-basis: 332px; min-height: 540px; } .path-document { padding-left: 20px; padding-right: 20px; } }"
        appendLine builder "@media (max-width: 900px) { .path-document__row { gap: 16px; } .slice-card { flex-basis: 310px; min-height: 520px; } }"
        appendLine builder "</style>"
