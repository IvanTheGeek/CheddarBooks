        ...
        testList
            ...
            [ testCase "Expense kinds map to stable slugs" (fun () ->
              ...
              testCase "NM path renderer sequences the first ATLAS-style mixed path" (fun () ->
                  ...
                  Expect.stringContains htmlDocument "Bounded Context badge" "Expected the popovers to identify bounded-context badges explicitly."
                  Expect.stringContains htmlDocument "Lens badge" "Expected the popovers to identify lens badges explicitly."
                  Expect.stringContains htmlDocument "Actor badge" "Expected the popovers to identify actor badges explicitly."
