        ...
        testList
            ...
            [ testCase "Expense kinds map to stable slugs" (fun () ->
              ...
              testCase "NM path renderer sequences the first ATLAS-style mixed path" (fun () ->
                  ...
                  Expect.stringContains htmlDocument "slice-card__embedded-body" "Expected the embedded AEM body to render without the outer slice shell."
                  ...
                  Expect.stringContains htmlDocument "data-pill-type=\"screen-role\"" "Expected AEM screen compartments to carry the actor badge locally."
